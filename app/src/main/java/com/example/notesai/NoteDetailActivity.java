...
public class NoteDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (existingNote != null) {
            ...
            // Show summarize button for existing notes with content
            if (!TextUtils.isEmpty(existingNote.getContent())) {
        ...
        // Show summarize button when content is entered (for new notes)
    ...
    private void summarizeNote() {
        ...
        // TODO: Connect to API for summarization
        // This method will be implemented later to call the summarization API
